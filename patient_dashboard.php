...
<header class="TB">
  <div class="LOGO">
    <!-- Clickable logo → opens logo editor -->
    
    <!-- ╔══════════════════════════════════════════════════════════════╗
         ║              LOGO PLACEHOLDER — شعارك هنا                 ║
         ║                                                              ║
         ║  طريقة التغيير:                                             ║
         ║  1. Emoji سريع : عدّل <span id="LOGO-EMJ">🏥</span>       ║
         ║  2. صورة PNG/SVG : ضع src في <img id="LOGO-IMG">           ║
         ║     ثم أزل style="display:none" منها                        ║
         ║     وأضف style="display:none" على <span id="LOGO-EMJ">     ║
         ║  3. اسم التطبيق : عدّل <div id="APP-NAME">MediSmart        ║
         ║  4. وصف صغير   : عدّل [data-t="appSub"]                    ║
         ╚══════════════════════════════════════════════════════════════╝ -->
    <div class="LI" id="LOGO-BTN" onclick="opPanel('LE')" style="cursor:pointer;" title="تعديل الشعار">
      <img id="LOGO-IMG" style="display:none;width:60%;height:60%;object-fit:cover;border-radius:11px;">

      <!-- ============================================================
           👇 ضع رابط لوغو خاصتك هنا في خاصية src
           مثال: src="logo.png"  أو  src="images/my-logo.svg"
           ============================================================ -->
      <img src="medchifagz.png" alt="Logo" style="width:100%;height:100%;object-fit:contain;border-radius:11px;display:block;vertical-align:middle;">

    </div>
    <div>
      <div class="LT2" id="APP-NAME" style="cursor:pointer;" onclick="opPanel('LE')">MedChifaGiz</div>
      <div style="font-size:9px;color:#9ca3af;" data-t="appSub">التطبيق الطبي الذكي</div>
    </div>
    <span style="font-size:13px;font-weight:700;color:#1a2340;margin-right:6px;" id="DT" data-t="dashboard">لوحة تحكم المريض</span>
  </div>
  <div class="TR">
    <!-- Clickable profile pill → opens profile panel -->
    <div class="PI" style="cursor:pointer;" onclick="opPanel('PP2')">
      <div class="AV" id="TAV">م</div>
      <span class="PN" id="TNM">المريض</span>
      <i class="fas fa-chevron-down" style="font-size:9px;color:#9ca3af;margin-right:2px;"></i>
    </div>
    <!-- Notifications button → opens notification panel -->
    <div style="position:relative;">
      <button class="IB" id="BN" onclick="opPanel('NP')"><i class="fas fa-bell" onclick="openNotifications()"></i><span class="NB" id="NBADGE" style="animation:NBP 1.5s infinite;">3</span></button>
    </div>
    <div style="position:relative;">
      <button class="IB" id="BLG"><i class="fas fa-globe"></i></button>
      <div class="DR" id="LD" style="min-width:130px;">
        <div class="LI2" onclick="setLang('ar')">🇩🇿 العربية</div>
        <div class="LI2" onclick="setLang('fr')">🇫🇷 Français</div>
        <div class="LI2" onclick="setLang('en')">🇬🇧 English</div>
      </div>
    </div>
...
<!-- CHARITY -->
<div class="CD" id="CCH">
  <div class="CH"><div class="CI">🤝</div><div><div class="CT" data-t="charity">الجمعيات الخيرية</div><div class="CS" data-t="charitySub">ابحث عن الجمعيات في منطقتك</div></div><i class="fas fa-chevron-left CA"></i></div>
  <div class="CB">
    <div class="FB">
      <select class="FS" id="WCH" onchange="ldComGeneric(this,'COM_CCH'); loadSection('associations','ch-lst','WCH','COM_CCH')"><option value="" data-t="wilaya">📍 الولاية</option></select>
      <select class="FS" id="COM_CCH" onchange="loadSection('associations','ch-lst','WCH','COM_CCH')"><option value="" data-t="commune">البلدية</option></select>
    </div>
    <div id="ch-lst">
      <div id="ch-lst-pagination" style="display:none;">
    <button class="prev" onclick="prevSection('associations','ch-lst')">➡️ السابق</button>
    <button class="next" onclick="nextSection('associations','ch-lst')">التالي ⬅️</button>
</div>
      <div id="ch-lst-results" class="IL"></div>
    </div>
<div class="actions-vertical">

  <button class="btn-doctors btn-near"
    onclick="getNearby('associations','map-associations')">
    🤝 جمعيات قريبة مني
  </button>

  <button class="btn-doctors btn-other"
    onclick="openNearby('associations','map-associations')">
    🌍 جمعيات من Google Maps
  </button>

</div>
    <div id="map-associations" style="display:none; height:250px; margin-top:20px;"></div>
  </div>
</div>

<!-- ELDERLY -->
<div class="CD" id="CEL">
  <div class="CH"><div class="CI">👴</div><div><div class="CT" data-t="elderly">دار العجزة</div><div class="CS" data-t="elderlySub">رعاية المسنين في جميع الولايات</div></div><i class="fas fa-chevron-left CA"></i></div>
  <div class="CB">
    <div class="FB">
      <select class="FS" id="WEL" onchange="ldComGeneric(this,'COM_CEL'); loadSection('elderly','el-lst','WEL','COM_CEL')"><option value="" data-t="wilaya">📍 الولاية</option></select>
      <select class="FS" id="COM_CEL" onchange="loadSection('elderly','el-lst','WEL','COM_CEL')"><option value="" data-t="commune">البلدية</option></select>
    </div>
    <div id="el-lst">
      <div id="el-lst-pagination" style="display:none;">
    <button class="prev" onclick="prevSection('elderly','el-lst')">➡️ السابق</button>
    <button class="next" onclick="nextSection('elderly','el-lst')">التالي ⬅️</button>
</div>
      <div id="el-lst-results" class="IL"></div>
    </div>
    <div class="actions-vertical">

  <button class="btn-doctors btn-near"
    onclick="getNearby('elderly','map-elderly')">
    👴 دور العجزة القريبة مني
  </button>

  <button class="btn-doctors btn-other"
    onclick="openNearby('elderly','map-elderly')">
    🌍 دور العجزة من Google Maps
  </button>

</div>
    <div id="map-elderly" style="display:none; height:250px; margin-top:20px;"></div>
  </div>
</div>

<!-- ORPHANAGE -->
<div class="CD" id="COR">
  <div class="CH"><div class="CI">🏠</div><div><div class="CT" data-t="orphanage">دار الأيتام</div><div class="CS" data-t="orphanageSub">دعم وكفالة الأيتام</div></div><i class="fas fa-chevron-left CA"></i></div>
  <div class="CB">
    <div class="FB">
      <select class="FS" id="WOR" onchange="ldComGeneric(this,'COM_COR'); loadSection('orphans','or-lst','WOR','COM_COR')"><option value="" data-t="wilaya">📍 الولاية</option></select>
      <select class="FS" id="COM_COR" onchange="loadSection('orphans','or-lst','WOR','COM_COR')"><option value="" data-t="commune">البلدية</option></select>
    </div>
    <div id="or-lst">
      <div id="or-lst-pagination" style="display:none;">
    <button class="prev" onclick="prevSection('orphans','or-lst')">➡️ السابق</button>
    <button class="next" onclick="nextSection('orphans','or-lst')">التالي ⬅️</button>
</div>
      <div id="or-lst-results" class="IL"></div>
    </div>
    <div class="actions-vertical">

  <button class="btn-doctors btn-near"
    onclick="getNearby('orphans','map-orphans')">
    🧒 دور الأيتام القريبة مني
  </button>

  <button class="btn-doctors btn-other"
    onclick="openNearby('orphans','map-orphans')">
    🌍 دور الأيتام من Google Maps
  </button>

</div>
    <div id="map-orphans" style="display:none; height:250px; margin-top:20px;"></div>
  </div>
</div>
...
">
 ...
 <div class="ST" style="justify-content:center;font-size:28px;font-weight:800;margin-bottom:20px;gap:10px;">
  ...
  <div class="record-step" style="display:none;">
    ...
    <div class="FG"><label class="FL">الحساسية</label><textarea class="FI FTA" id="allergy"></textarea></div>
    <button class="BT BO" onclick="prevRecordStep()">السابق</button>
    <button class="BT BP" onclick="nextRecordStep()">التالي</button>
  </div>

  <div class="record-step" style="display:none;">
    <div class="FG"><label class="FL">الأدوية الحالية</label><textarea class="FI FTA" id="meds"></textarea></div>
...
<div class="VW" id="VDL">
  ...
  <!-- Tab bar: Form / History -->
  <div class="DJ-TABS">
    <button class="DJ-TAB A" data-tab="form"    onclick="djTab('form')">   <i class="fas fa-edit"></i> تسجيل اليوم</button>
    <button class="DJ-TAB"   data-tab="history" onclick="djTab('history')"><i class="fas fa-history"></i> السجل</button>
  </div>
...
<div class="VW" id="VPR">
  ...
  <div id="pc-panel-preg" class="pc-tab-panel pc-animate">
    ...
    <div class="preg-hero">
      <div class="preg-hero-top">
        <div>
          <div class="preg-week-badge pc-hero-week">الأسبوع 24</div>
          <div class="preg-hero-title" style="margin-top:10px;">مرحباً أماً رائعة 🌸</div>
          <div class="preg-hero-sub">
            الولادة المتوقعة:
            <strong style="color:#fff;" id="pc-edd">—</strong>
          </div>
          <div class="preg-hero-sub" style="margin-top:2px;">
            المرحلة:
            <strong style="color:#fff;" id="pc-trimester-label">—</strong>
          </div>
        </div>
        <!-- AI Health Score Circle -->
        <div class="preg-ai-score-wrap">
          <div class="preg-ai-score-circle">
            <svg viewBox="0 0 64 64" width="64" height="64">
              <circle cx="32" cy="32" r="28" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="5"/>
              <circle id="pc-score-circle-bar" cx="32" cy="32" r="28" fill="none"
                stroke="#fff" stroke-width="5" stroke-linecap="round"
                style="stroke-dasharray:176;stroke-dashoffset:44;transition:stroke-dashoffset 1.2s ease;"/>
            </svg>
            <div class="score-text">
              <span id="pc-score-text">85</span>
              <span class="score-label">AI صحة</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Mini Stats Grid -->
      <div class="preg-hero-grid">
        <div class="preg-mini-card">
          <div class="mc-label">🍼 حجم الجنين</div>
          <div class="mc-value" id="pc-fetus-size">ذرة</div>
        </div>
        <div class="preg-mini-card">
          <div class="mc-label">🩸 فصيلة الدم</div>
          <div class="mc-value"><?= htmlspecialchars($patient['blood_type'] ?? '—') ?></div>
        </div>
        <div class="preg-mini-card">
          <div class="mc-label">⚖️ الوزن الحالي</div>
          <div class="mc-value"><?= htmlspecialchars($patient['weight'] ?? '—') ?> كغ</div>
        </div>
        <div class="preg-mini-card">
          <div class="mc-label">📏 الطول</div>
          <div class="mc-value"><?= htmlspecialchars($patient['height'] ?? '—') ?> سم</div>
        </div>
      </div>

      <!-- AI Daily Tip -->
      <!-- ⚡ AI_INTEGRATION: Replace static tip with Gemini dynamic tip -->
      <div class="preg-ai-tip">
        <div class="tip-icon">💡</div>
        <div>
          <strong style="display:block;margin-bottom:2px;font-size:12px;">نصيحة اليوم من AI</strong>
          <span id="pc-daily-tip">احرصي على تناول 400 مكغ حمض الفوليك يومياً — يحمي من تشوهات الأنبوب العصبي للجنين.</span>
        </div>
      </div>
    </div>

    <!-- ② Fetus Visualizer + Week Detail -->
    <div class="fetus-visual-card">
      <div class="pc-section-title">
        <span>🧬</span> تطور الجنين
        <span class="stag">AI</span>
      </div>
      <div class="fetus-body">
        <!-- Animated fetus SVG -->
        <div class="fetus-svg-wrap">
          <svg width="80" height="80" viewBox="0 0 80 80">
            <defs>
              <radialGradient id="fg1" cx="50%" cy="50%" r="50%">
                <stop offset="0%" style="stop-color:#06d6a0;stop-opacity:0.18"/>
                <stop offset="100%" style="stop-color:#00b4d8;stop-opacity:0.06"/>
              </radialGradient>
            </defs>
            <circle cx="40" cy="40" r="38" fill="url(#fg1)" stroke="rgba(0,180,216,0.25)" stroke-width="1.5"/>
            <!-- Head -->
            <ellipse cx="40" cy="22" rx="13" ry="11" fill="rgba(0,180,216,0.35)" stroke="rgba(0,119,182,0.5)" stroke-width="1.5"/>
            <!-- Body -->
            <path d="M32 33 Q25 48 28 60 Q40 65 52 60 Q55 48 48 33 Z" fill="rgba(6,214,160,0.3)" stroke="rgba(0,180,216,0.4)" stroke-width="1.5"/>
            <!-- Arms -->
            <path d="M31 40 Q20 44 22 52" stroke="rgba(0,180,216,0.55)" stroke-width="2.5" fill="none" stroke-linecap="round"/>
            <path d="M49 40 Q60 44 58 52" stroke="rgba(0,180,216,0.55)" stroke-width="2.5" fill="none" stroke-linecap="round"/>
            <!-- Heart pulse -->
            <circle cx="40" cy="46" r="3" fill="rgba(247,37,133,0.6)">
        ...
        <div class="fetus-info">
          <h3 id="pc-fetus-title">الأسبوع 24 — يسمع صوتك!</h3>
          <p id="pc-fetus-desc">الجنين يسمع أصواتاً خارجية. الرئتان تتطوران. يزن حوالي 600 غرام.</p>
          <div class="fetus-size-chips">
            <span class="fetus-chip">⚖️ ~600 غ</span>
            <span class="fetus-chip">📏 ~30 سم</span>
            <span class="fetus-chip">❤️ 150 نبضة/د</span>
          </div>
        </div>
      </div>

      <!-- Scrollable Week Timeline -->
      <div class="pc-section-title" style="margin-bottom:8px;"><span>📅</span> الجدول الزمني</div>
      <div class="preg-timeline-scroll">
        <div class="preg-timeline-track" id="pc-tl-track">
          <!-- Built by JS: pcBuildTimeline() -->
        </div>
      </div>

      <!-- Week Detail Box -->
      <div id="pc-week-detail" style="display:none;background:rgba(0,180,216,0.06);border:1.5px solid rgba(0,180,216,0.2);border-radius:12px;padding:12px;margin-top:10px;" class="pc-animate"></div>
    </div>

    <!-- ③ Symptoms Tracker -->
    <div class="pc-section-card">
      <div class="pc-section-title">
        <span>🩺</span> متابعة الأعراض
        <span class="stag">AI تقييم</span>
      </div>
      <div class="symptoms-grid">
        <div class="symptom-item">
          <div class="symptom-label">🤢 غثيان</div>
          <input type="range" class="symptom-slider" min="0" max="4" value="1" oninput="pcUpdateSymptom('nausea',this.value)">
          <div class="symptom-val" id="pc-sym-val-nausea">خفيف</div>
        </div>
        <div class="symptom-item">
          <div class="symptom-label">🤕 صداع</div>
          <input type="range" class="symptom-slider" min="0" max="4" value="0" oninput="pcUpdateSymptom('headache',this.value)">
          <div class="symptom-val" id="pc-sym-val-headache">طبيعي</div>
        </div>
        <div class="symptom-item">
          <div class="symptom-label">😵 دوخة</div>
          <input type="range" class="symptom-slider" min="0" max="4" value="0" oninput="pcUpdateSymptom('dizzy',this.value)">
          <div class="symptom-val" id="pc-sym-val-dizzy">طبيعي</div>
        </div>
        <div class="symptom-item">
          <div class="symptom-label">🦵 تورم</div>
          <input type="range" class="symptom-slider" min="0" max="4" value="1" oninput="pcUpdateSymptom('swelling',this.value)">
          <div class="symptom-val" id="pc-sym-val-swelling">خفيف</div>
        </div>
        <div class="symptom-item">
          <div class="symptom-label">🔙 ألم ظهر</div>
          <input type="range" class="symptom-slider" min="0" max="4" value="1" oninput="pcUpdateSymptom('back',this.value)">
          <div class="symptom-val" id="pc-sym-val-back">خفيف</div>
        </div>
        <div class="symptom-item">
          <div class="symptom-label">👶 حركة الجنين</div>
          <input type="range" class="symptom-slider" min="0" max="4" value="3" oninput="pcUpdateSymptom('movement',this.value)">
          <div class="symptom-val" id="pc-sym-val-movement">مرتفع</div>
        </div>
      </div>
      <!-- AI Result -->
      <div id="pc-symptom-result" class="ai-symptom-result green" style="display:flex;">
        <span style="font-size:18px;flex-shrink:0">✅</span>
        <div>الأعراض طبيعية جداً. استمري بالنمط الصحي الحالي.</div>
      </div>
    </div>

    <!-- ④ Pregnancy Nutrition AI -->
    <div class="pc-section-card">
      <div class="pc-section-title">
        <span>🥗</span> التغذية الذكية
        <span class="stag">AI توصية</span>
      </div>
      <div class="nutrition-cols">
        <div class="nutrition-col good">
          <h4>✅ مفيد</h4>
          <div class="nutri-item">🥬 خضراوات ورقية</div>
          <div class="nutri-item">🐟 سمك سلمون</div>
          <div class="nutri-item">🥚 بيض مسلوق</div>
          <div class="nutri-item">🫐 توت</div>
          <div class="nutri-item">🥛 حليب كامل</div>
        </div>
        <div class="nutrition-col vitamins">
          <h4>💊 فيتامينات</h4>
          <div class="nutri-item">حمض الفوليك</div>
          <div class="nutri-item">حديد</div>
          <div class="nutri-item">كالسيوم</div>
          <div class="nutri-item">فيتامين D</div>
          <div class="nutri-item">أوميغا 3</div>
        </div>
        <div class="nutrition-col bad">
          <h4>🚫 ممنوع</h4>
          <div class="nutri-item">🐟 سمك خام</div>
          <div class="nutri-item">☕ كافيين زائد</div>
          <div class="nutri-item">🧀 جبن طري</div>
          <div class="nutri-item">🍺 كحول</div>
          <div class="nutri-item">🥩 لحم نيء</div>
        </div>
      </div>
    </div>
    ...
    <!-- ⑤ Reminders -->
    <div class="pc-section-card">
      <div class="pc-section-title"><span>⏰</span> تذكيرات اليوم</div>
      <div class="reminders-list">
        <div class="reminder-item">
          <div class="reminder-icon" style="background:rgba(0,180,216,0.12);">🩺</div>
          <div class="reminder-text">
            <strong>موعد الطبيب</strong>
            <span>د. نادية عمراني — <?= date('d/m/Y', strtotime('+7 days')) ?></span>
          </div>
          <div class="reminder-check" onclick="pcToggleReminder(this)"></div>
        </div>
        <div class="reminder-item">
          <div class="reminder-icon" style="background:rgba(6,214,160,0.12);">🧪</div>
          <div class="reminder-text">
            <strong>تحليل الدم</strong>
            <span>تحليل دوري — الأسبوع القادم</span>
          </div>
          <div class="reminder-check" onclick="pcToggleReminder(this)"></div>
        </div>
        <div class="reminder-item">
          <div class="reminder-icon" style="background:rgba(245,158,11,0.12);">💊</div>
          <div class="reminder-text">
            <strong>حمض الفوليك</strong>
            <span>الجرعة اليومية — صباحاً</span>
          </div>
          <div class="reminder-check" onclick="pcToggleReminder(this)"></div>
        </div>
        <div class="reminder-item">
          <div class="reminder-icon" style="background:rgba(59,130,246,0.12);">💧</div>
          <div class="reminder-text">
            <strong>شرب الماء</strong>
            <span>8-10 أكواب يومياً</span>
          </div>
          <div class="reminder-check" onclick="pcToggleReminder(this)"></div>
        </div>
        <div class="reminder-item">
          <div class="reminder-icon" style="background:rgba(139,92,246,0.12);">🛌</div>
          <div class="reminder-text">
            <strong>الراحة</strong>
            <span>8 ساعات نوم — تجنبي الإجهاد</span>
          </div>
          <div class="reminder-check" onclick="pcToggleReminder(this)"></div>
        </div>
      </div>
    ...
    <!-- ⑥ Emergency -->
    <button class="pc-emergency-btn" onclick="if(typeof window.BSOS !== 'undefined') document.getElementById('BSOS').click(); else alert('اتصلي بـ 15 — خدمات الطوارئ الجزائر');">
      <i class="fas fa-ambulance"></i>
      طوارئ الحامل — اتصال فوري
    </button>
    ...
    <div class="pc-chat-wrap">
      <div class="pc-chat-header">
        ...
        <div>
          <div class="ch-title">مساعدة الحمل الذكية</div>
          <div class="ch-sub">اسأليني عن حملك — أنا هنا لأساعدك</div>
        </div>
      </div>
      <div class="pc-chat-chips">
        <button class="pc-chat-chip" onclick="pcPregChip('ما هي أعراض الحمل الطبيعية في الأسبوع 24؟')">أعراض طبيعية</button>
        <button class="pc-chat-chip" onclick="pcPregChip('ماذا أفعل عند الغثيان الشديد؟')">علاج الغثيان</button>
        <button class="pc-chat-chip" onclick="pcPregChip('متى تكون حركة الجنين قليلة؟')">حركة الجنين</button>
        <button class="pc-chat-chip" onclick="pcPregChip('ما هي الرياضة المناسبة للحامل؟')">رياضة آمنة</button>
      </div>
      <div class="pc-chat-msgs" id="pc-preg-chat-msgs">
        <div class="pc-chat-msg bot">
          مرحباً أماً رائعة! 🌸<br>
          أنا مساعدتك الذكية لمتابعة الحمل.<br>
          يمكنني الإجابة على أسئلتك عن الحمل والتغذية والأعراض. 💕
        </div>
      </div>
      <div class="pc-chat-input-row">
        <input class="pc-chat-input" id="pc-preg-chat-in" placeholder="اكتبي سؤالك هنا..." dir="rtl">
        <button class="pc-chat-send" onclick="pcSendPregChat()"><i class="fas fa-paper-plane"></i></button>
      </div>
    </div>
  ...
  <div id="pc-panel-chronic" class="pc-tab-panel" style="display:none;">
    ...
    <!-- ④ Readings Chart -->
    <div class="pc-section-card">
      <div class="pc-section-title"><span>📊</span> تاريخ القراءات</div>
      <div class="chart-area">
        <div class="chart-canvas-wrap">
          <canvas id="pc-chart-canvas" class="pc-chart"></canvas>
        </div>
      </div>
      <div class="chart-legend" id="pc-chart-legend">
        <div class="legend-item"><div class="legend-dot" style="background:#00b4d8;"></div>القراءة الأولى</div>
        <div class="legend-item"><div class="legend-dot" style="background:#f59e0b;"></div>القراءة الثانية</div>
      </div>
    </div>
    ...
    <!-- ⑦ Emergency -->
    <button class="pc-emergency-btn" onclick="if(typeof window.BSOS !== 'undefined') document.getElementById('BSOS').click(); else alert('اتصل بـ 15 — خدمات الطوارئ الجزائر');">
      <i class="fas fa-ambulance"></i>
      طوارئ — اتصال فوري
    </button>
    ...
    <!-- ⑧ Chronic AI Chat -->
    <div class="pc-chat-wrap">
      <div class="pc-chat-header ch-chat-header">
        <div class="ch-icon">🤖</div>
        <div>
          <div class="ch-title">مساعد الأمراض المزمنة AI</div>
          <div class="ch-sub">تحليل وإرشادات مخصصة لحالتك</div>
        </div>
      </div>
      <div class="pc-chat-chips">
        <button class="pc-chat-chip" style="border-color:rgba(0,180,216,0.3);color:#0077b6;" onclick="pcChronicChip('كيف أتحكم بسكر الدم بعد الأكل؟')">تحكم السكر</button>
        <button class="pc-chat-chip" style="border-color:rgba(0,180,216,0.3);color:#0077b6;" onclick="pcChronicChip('ما هي أسباب ارتفاع الضغط؟')">أسباب الضغط</button>
        <button class="pc-chat-chip" style="border-color:rgba(0,180,216,0.3);color:#0077b6;" onclick="pcChronicChip('ما الأطعمة المناسبة لمريض السكري؟')">نظام غذائي</button>
        <button class="pc-chat-chip" style="border-color:rgba(0,180,216,0.3);color:#0077b6;" onclick="pcChronicChip('متى يجب أن أذهب للطوارئ؟')">متى أذهب للطوارئ</button>
      </div>
      <div class="pc-chat-msgs" id="pc-ch-chat-msgs">
        <div class="pc-chat-msg bot">
          مرحباً! أنا مساعدك الذكي للأمراض المزمنة 🤖<br>
          يمكنني تحليل قراءاتك وتقديم توصيات مخصصة لحالتك الصحية. 💊
        </div>
      </div>
      <div class="pc-chat-input-row">
        <input class="pc-chat-input" id="pc-ch-chat-in" placeholder="اسأل عن مرضك هنا..." dir="rtl">
        <button class="pc-chat-send" onclick="pcSendChronicChat()" style="background:linear-gradient(135deg,#00b4d8,#0077b6);">
          <i class="fas fa-paper-plane"></i>
        </button>
      </div>
    </div>
  ...
  <div class="PP2-BD">
    ...
    <div class="PP2-SEC">
      ...
      <div class="PP2-IT">
        ...
        <div style="flex:1;min-width:0;">
          <div class="PP2-IT-L">الحساسية</div>
